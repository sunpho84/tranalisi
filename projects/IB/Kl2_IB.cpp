...
int main(int narg,char **arg)
{
  ...
  djack_t k_Z,k_M,k_A_exch,k_SL_exch,k_A_selftad,k_SL_selftad,k_A_selftad_revins,k_SL_selftad_revins,k_A_s,k_SL_s,k_A_s_revins,k_SL_s_revins,k_A_p,k_SL_p,k_A_p_revins,k_SL_p_revins;
  ...
  two_pts_with_ins_ratio_fit(k_Z,k_M,k_A_s_revins,k_SL_s_revins,k_plain,k_s_revins,TH,k_tmin,k_tmax,"kaon_mass.xmg","k_s_revins.xmg");
  ...
  djack_t D_Z,D_M,D_A_exch,D_SL_exch,D_A_selftad,D_SL_selftad,D_A_selftad_revins,D_SL_selftad_revins,D_A_s,D_SL_s,D_A_s_revins,D_SL_s_revins,D_A_p,D_SL_p,D_A_p_revins,D_SL_p_revins;
  ...
  two_pts_with_ins_ratio_fit(D_Z,D_M,D_A_s_revins,D_SL_s_revins,D_plain,D_s_revins,TH,D_tmin,D_tmax,"D_mass.xmg","D_s_revins.xmg");
  ...
  if(ibeta==5)
    {
      two_pts_with_ins_ratio_fit(D_Z,D_M,D_A_s_revins,D_SL_s_revins,D_plain,D_s_revins,TH,D_tmin,40,"D_mass.xmg","D_s_revins.xmg");
      two_pts_with_ins_ratio_fit(D_Z,D_M,D_A_p_revins,D_SL_p_revins,D_plain,D_p_revins,TH,D_tmin,40,"D_mass.xmg","D_p_revins.xmg");
      two_pts_with_ins_ratio_fit(D_Z,D_M,D_A_selftad_revins,D_SL_selftad_revins,D_plain,djvec_t(D_self_revins+D_tad_revins),TH,D_tmin,40,"D_mass.xmg","D_selftad_revins.xmg");
    }
