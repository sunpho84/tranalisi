...
template <class TL,class Ta,class TD> TD FSE_dep_pion_savage_new_exp_bis(const TD &D1,const TD &D2,const TD &M,const Ta &a,const TL &L)
{return e2/(L*a*L*a*L*a)/3.0*M*(D1*pow(pion_charge_radius,2.0)+D2*a*a);}

template <class TL,class Ta,class TD> TD FSE_dep_kaon_savage_bis(const TD &D1,const TD &D2,const TD &M,const Ta &a,const TL &L)
{return e2/(L*a*L*a*L*a)/3.0*M*(D1*pow(kaon_charge_radius,2.0)+D2*a*a);}
...
Tpars cont_chir_ansatz_dM2Pi(const Tpars &f0,const Tpars &B0,const Tpars &C,const Tpars &K,const Tpars &quad_dep,const Tml &ml,
			     const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &L4dep,const Tpars &adep_ml,const size_t an_flag)
{
  Tpars
    Cf04=C/sqr(sqr(f0)),
    M2=2.0*B0*ml,
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=-(3.0+16.0*Cf04)*M2/den*log(M2/pow(4.0*M_PI*f0,2.0));
  ...
  Tpars fitted_FSE;
  if(FSE_an(an_flag))  fitted_FSE=FSE_dep_pion_savage_new_exp_bis(L3dep,L4dep,sqrtM2,a,L);
  else                 fitted_FSE=0.0;
			    ...
			    const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  ave_err_t L3dep_Guess={1.0,0.1};
  ave_err_t L4dep_Guess={1.0,1.0};
  ...
  if(FSE_an(an_flag)==0)
    {
      ...
      boot_fit.fix_par_to(pars.iL4dep,0.0);
    }
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,2.0,0.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_ansatz_dM2Pi(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKPi],p[pars.iK2Pi],ml,ac,p[pars.iadep],L,p[pars.iL3dep],p[pars.iL4dep],p[pars.iadep_ml],an_flag);},cov_flag);
  dboot_t phys_res=cont_chir_ansatz_dM2Pi(pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.K2Pi,ml_phys,a_cont,pars.adep,inf_vol,pars.L3dep,pars.L4dep,pars.adep_ml,an_flag);
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {return cont_chir_ansatz_dM2Pi<double,double,double>
		      (pars.fit_f0.ave(),pars.fit_B0.ave(),pars.C.ave(),pars.KPi.ave(),pars.K2Pi.ave(),x,
		       pars.fit_a[ib].ave(),pars.adep.ave(),inf_vol,pars.L3dep.ave(),pars.L4dep.ave(),pars.adep_ml.ave(),an_flag);},
		  bind(cont_chir_ansatz_dM2Pi<dboot_t,double,double>,pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.K2Pi,_1,
		       a_cont,pars.adep,inf_vol,pars.L3dep,pars.L4dep,pars.adep_ml,an_flag),
		  ...
		  {if(univ_full_sub==0)
			...
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)/sqr(pars.fit_a[ib])-
				       without_with_fse*FSE_dep_pion_savage_new_exp_bis(pars.L3dep,pars.L4dep,dboot_t(pow(2.0*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_a[ib],ext_data[idata].L));
		      }
		  },
		  ml_phys,phys_res,"M\\S2\\N\\s\\x\\p\\f{}\\S+\\N\\h{0.2}-\\h{0.2}M\\S2\\N\\s\\xp\\f{}\\S0\\N\\h{0.3}(GeV\\S2\\N)",beta_list,univ_full_sub,an_flag);
...
Tpars cont_chir_ansatz_dM2K_QED(const Tpars &f0,const Tpars &B0,const Tpars &C,const Tpars &Kpi,const Tpars &Kk,const Tpars &quad_dep,const Tm &ml,
				const Tm &ms,const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &L4dep,const Tpars &adep_ml,const size_t an_flag)
{
  Tpars
    Cf04=C/sqr(sqr(f0)),
    M2Pi=2.0*B0*ml,
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=-8.0/3.0*M2Pi/den*log(M2Pi/pow(4.0*M_PI*f0,2.0));
  ...
  Tpars fitted_FSE;
  if(FSE_an(an_flag))  fitted_FSE=FSE_dep_kaon_savage_bis(L3dep,L4dep,sqrtM2K,a,L);
  else                 fitted_FSE=0.0;
...
dboot_t cont_chir_fit_dM2K_QED(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const dboot_t &ms_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,2.0,0.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_ansatz_dM2K_QED(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKPi],p[pars.iKK],p[pars.iK2Pi],ml,ms,ac,p[pars.iadep],L,p[pars.iL3dep],p[pars.iL4dep],p[pars.iadep_ml],an_flag);},cov_flag);
  
  dboot_t phys_res=cont_chir_ansatz_dM2K_QED(pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.KK,pars.K2Pi,ml_phys,ms_phys,a_cont,pars.adep,inf_vol,pars.L3dep,pars.L4dep,pars.adep_ml,an_flag);
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {return cont_chir_ansatz_dM2K_QED<double,double,double>
		      (pars.fit_f0.ave(),pars.fit_B0.ave(),pars.C.ave(),pars.KPi.ave(),pars.KK.ave(),pars.K2Pi.ave(),x,
		       ms_phys.ave(),pars.fit_a[ib].ave(),pars.adep.ave(),inf_vol,pars.L3dep.ave(),pars.L4dep.ave(),pars.adep_ml.ave(),an_flag);},
		  bind(cont_chir_ansatz_dM2K_QED<dboot_t,double,double>,pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.KK,pars.K2Pi,_1,
		       ms_phys.ave(),a_cont,pars.adep,inf_vol,pars.L3dep,pars.L4dep,pars.adep_ml,an_flag),
		  [&ext_data,&pars,univ_full_sub]
		  (size_t idata,bool without_with_fse,size_t ib)
		  {if(univ_full_sub==0)
		      {
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse)/sqr(pars.fit_a[ib]));
		      ...
		      {
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)/sqr(pars.fit_a[ib])-
				       without_with_fse*FSE_dep_kaon_savage_bis(pars.L3dep,pars.L4dep,dboot_t(pow(pars.fit_B0*(ext_data[idata].aml+ext_data[idata].ams)/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_a[ib],ext_data[idata].L));
		      }
		  },
		  ml_phys,phys_res,"[M\\S2\\N\\sK\\S+\\N\\h{0.2}-\\h{0.2}M\\S2\\N\\sK\\S0\\N]\\S\\f{Times-Italic}QED\\N\\f{}\\h{0.3}(GeV\\S2\\N)",beta_list,univ_full_sub,an_flag);
				...
				const Ta &a,const Tpars &adep,double L,const Tpars &fvedep,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=-M2/den*log(M2/pow(4.0*M_PI*f0,2.0));
  else                 chir_dep=quad_dep*pow(M2/den,2.0);
...
//! ansatz fit
template <class Tpars,class Tm,class Ta>
Tpars cont_chir_ansatz_dM2D_QCD(const Tpars &f0,const Tpars &B0,const Tpars &C0,const Tpars &C1,const Tm &ml,
				const Ta &a,const Tpars &adep,double L,const Tpars &fvedep,const size_t an_flag)
{
  Tpars
    M2=2.0*B0*ml,
...
dboot_t cont_chir_fit_dM2D_QCD(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  ave_err_t adep_Guess={0.01,0.008};
  ave_err_t adep_ml_Guess={0.0,0.1};
  ave_err_t C_Guess={0.01,0.005};
  ave_err_t KPi_Guess={0.1,0.05};
  ave_err_t KK_Guess={0.0,0.1};
  ave_err_t K2Pi_Guess={0.0,0.1};
  ave_err_t K2K_Guess={0.0,0.1};
  ave_err_t L3dep_Guess={700.0,200.0};
  ave_err_t L4dep_Guess={0.0,0.1};
  ave_err_t ML4dep_Guess={0.0,0.1};
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,1.0,1.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_ansatz_dM2D_QCD(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKPi],ml,ac,p[pars.iadep],L,p[pars.iL3dep],an_flag);},cov_flag);
  
  dboot_t phys_res=cont_chir_ansatz_dM2D_QCD(pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,ml_phys,a_cont,pars.adep,inf_vol,pars.L3dep,an_flag);
  cout<<"dM2D_QCD: "<<phys_res.ave_err()<<endl;

  plot_chir_fit_empty(path,ext_data,pars,
		[&pars,an_flag]
		(double x,size_t ib)
		{return cont_chir_ansatz_dM2D_QCD<double,double,double>
		    (pars.fit_f0.ave(),pars.fit_B0.ave(),pars.C.ave(),pars.KPi.ave(),x,
		     pars.fit_a[ib].ave(),pars.adep.ave(),inf_vol,pars.L3dep.ave(),an_flag);},
		bind(cont_chir_ansatz_dM2D_QCD<dboot_t,double,double>,pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,_1,
		     a_cont,pars.adep,inf_vol,pars.L3dep,an_flag),
		[&ext_data,&pars]
		(size_t idata,bool without_with_fse,size_t ib)
		{return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse)*pars.fit_z[ib]/pars.fit_a[ib]-
				without_with_fse*pars.L3dep*dboot_t(pow(2.0*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.25)/pow(4.0*M_PI*pars.fit_f0,2.0)*exp(-pow(2.0*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)*ext_data[idata].L)/pow(ext_data[idata].L,1.5)));},
		ml_phys,phys_res,"[M\\S2\\N\\sD\\S+\\N\\h{0.2}-\\h{0.2}M\\S2\\N\\sD\\S0\\N]\\S\\f{Times-Italic}QCD\\N\\f{}\\h{0.3}(GeV\\S2\\N)",beta_list);
...
//! ansatz fit
template <class Tpars,class Tm,class Ta>
Tpars cont_chir_ansatz_M2Pi0g(const Tpars &f0,const Tpars &B0,const Tpars &C,const Tpars &Kpi0,const Tpars &quad_dep,const Tm &ml,
			      const Ta &a,const Tpars &adep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=0.0;
...
dboot_t cont_chir_fit_M2Pi0g(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,2.0,0.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_ansatz_M2Pi0g(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKPi],p[pars.iK2Pi],ml,ac,p[pars.iadep],p[pars.iadep_ml],an_flag);},cov_flag);
  
  dboot_t phys_res=cont_chir_ansatz_M2Pi0g(pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.K2Pi,ml_phys,a_cont,pars.adep,pars.adep_ml,an_flag);
  ...
  plot_chir_fit(path,ext_data,pars,
		...
		bind(cont_chir_ansatz_M2Pi0g<dboot_t,double,double>,pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.K2Pi,_1,
		     a_cont,pars.adep,pars.adep_ml,an_flag),
		[&ext_data,&pars]
		(size_t idata,bool without_with_fse,size_t ib)
		{return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse)/sqr(pars.fit_a[ib]));},
		ml_phys,phys_res,"[\\xd\\f{}M\\S2\\N\\s\\xp\\f{}\\S0\\N]\\S\\f{Times-Italic}QED\\N\\f{}\\h{0.3}(GeV\\S2\\N)",beta_list);
...
//! ansatz fit
template <class Tpars,class Tm,class Ta>
Tpars cont_chir_ansatz_M2K0g(const Tpars &f0,const Tpars &B0,const Tpars &C,const Tpars &Kk0,const Tpars &K,const Tpars &quad_dep,const Tpars &Klog,const Tm &ml,
			     const Ta &a,const Tpars &adep,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=Klog*(3.0+16.0*Cf04)*M2/(4.0*Cf04*den)*log(M2/pow(4.0*M_PI*f0,2.0));
  else                 chir_dep=quad_dep*pow(M2/den,2.0);
...
dboot_t cont_chir_fit_M2K0g(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,2.0,0.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_ansatz_M2K0g(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKK],p[pars.iKPi],p[pars.iK2Pi],p[pars.iK2K],ml,ac,p[pars.iadep],an_flag);},cov_flag);
  
  dboot_t phys_res=cont_chir_ansatz_M2K0g(pars.fit_f0,pars.fit_B0,pars.C,pars.KK,pars.KPi,pars.K2Pi,pars.K2K,ml_phys,a_cont,pars.adep,an_flag);
  ...
  plot_chir_fit(path,ext_data,pars,
		...
		bind(cont_chir_ansatz_M2K0g<dboot_t,double,double>,pars.fit_f0,pars.fit_B0,pars.C,pars.KK,pars.KPi,pars.K2Pi,pars.K2K,_1,
		     a_cont,pars.adep,an_flag),
		[&ext_data,&pars]
		(size_t idata,bool without_with_fse,size_t ib)
		{return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse)/sqr(pars.fit_a[ib]));},
		ml_phys,phys_res,"[\\xd\\f{}M\\S2\\N\\sK\\S0\\N]\\S\\f{Times-Italic}QED\\N\\f{}\\h{0.3}(GeV\\S2\\N)",beta_list);
...
dboot_t cont_chir_fit_epsilon(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  plot_chir_fit1(path,ext_data,pars,
		[&pars,an_flag]
		(double x,size_t ib)
				   ...
				   const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return Kpi0*M2/den/(4.0*Cf04+chir_dep+K*M2/den+fitted_FSE)+disc_eff;
}
...
dboot_t cont_chir_fit_epsilon_Pi0(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  ave_err_t C_Guess={3.55e-5,2.49e-6};
  ave_err_t KPi_Guess={9.0,2.0};
  ave_err_t KK_Guess={6.0,1.0};
  ave_err_t K2Pi_Guess={0.0,1.0};
  ave_err_t K2K_Guess={0.0,0.1};
  ave_err_t L3dep_Guess={1.0,1.0};
  ave_err_t L4dep_Guess={0.0,0.1};
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {if(univ_full_sub==0)
			...
			return dboot_t(without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse);
		      ...
		      {
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)/(1.0-(without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)*without_with_fse*FSE_dep_pion_savage_new_exp(pars.L3dep,dboot_t(pow(2.0*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_a[ib],ext_data[idata].L)));
		      }
		  },
		  ml_phys,phys_res,"\\xe\\f{}\\s\\xp\\f{}\\S0\\N",beta_list,univ_full_sub,an_flag);
				   ...
				   const Ta &a,const Tpars &adep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=K*M2/den*log(M2/pow(4.0*M_PI*f0,2.0));
  else                 chir_dep=0.0;
  ...
  return Kpi0/(4.0*Cf04)*M2/den*(1.0+chir_dep+quad_dep*M2/den)+disc_eff;
}
...
dboot_t cont_chir_fit_epsilon_Pi0(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag,const vector<string> &beta_list)
{
  ...
  plot_chir_fit1(path,ext_data,pars,
		...
		(size_t idata,bool without_with_fse,size_t ib)
		{return dboot_t(without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse);},
		ml_phys,phys_res,"\\xe\\f{}\\s\\xp\\f{}\\S0\\N",beta_list);
...
/////////////////////////////////////////////////////////////// generic linear fit FVE M////////////////////////////////////////////////////////////////////////

//! ansatz fit
template <class Tpars,class Tm,class Ta>
Tpars cont_chir_linear_ansatz_dM(const Tpars &C0,const Tpars &C1,const Tm &ml,const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const size_t an_flag,bool with_without_FSE)
{
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=C1*ml;
  else                 chir_dep=0.0;
...
dboot_t cont_chir_linear_fit_dM(const dbvec_t &a,const dbvec_t &z,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,const string &yaxis_label,double apow,double zpow,size_t an_flag,bool with_without_FSE,bool cov_flag,const vector<string> &beta_list)
{
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,apow,zpow,[an_flag,with_without_FSE](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double MD,double ac,double L)
			 {return cont_chir_linear_ansatz_dM(p[pars.iC],p[pars.iKPi],ml,ac,p[pars.iadep],L,p[pars.iL3dep],an_flag,with_without_FSE);},cov_flag);

  dboot_t phys_res=cont_chir_linear_ansatz_dM(pars.C,pars.KPi,ml_phys,a_cont,pars.adep,inf_vol,pars.L3dep,an_flag,with_without_FSE);
  ...
  for(int univ_full_sub=0;univ_full_sub<2;univ_full_sub++)
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  bind(cont_chir_linear_ansatz_dM<dboot_t,double,double>,pars.C,pars.KPi,_1,a_cont,pars.adep,inf_vol,pars.L3dep,an_flag,with_without_FSE),
		  [&ext_data,apow,zpow,&pars,univ_full_sub]
		  (size_t idata,bool without_with_fse,size_t ib)
		  {if(univ_full_sub==0)
		      {
			    ...
			    const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag)
{
  ...
  for(int univ_full_sub=0;univ_full_sub<2;univ_full_sub++)
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  ml_phys,phys_res,"M\\S2\\N\\s\\x\\p\\f{}\\S+\\N\\h{0.2}-\\h{0.2}M\\S2\\N\\s\\xp\\f{}\\S0\\N\\h{0.3}(GeV\\S2\\N)",beta_list,univ_full_sub);
				...
				const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=-8.0/3.0*M2/den*log(M2/pow(4.0*M_PI*f0,2.0));
  else                 chir_dep=quad_dep*pow(M2/den,2.0);
...
dboot_t cont_chir_fit_dM2K_QED(const dbvec_t &a,const dbvec_t &z,const dboot_t &f0,const dboot_t &B0,const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag)
{
  ...
  for(int univ_full_sub=0;univ_full_sub<2;univ_full_sub++)
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  ml_phys,phys_res,"[M\\S2\\N\\sK\\S+\\N\\h{0.2}-\\h{0.2}M\\S2\\N\\sK\\S0\\N]\\S\\f{Times-Italic}QED\\N\\f{}\\h{0.3}(GeV\\S2\\N)",beta_list,univ_full_sub);
				   ...
				   const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return Kpi0/(4.0*Cf04)*M2/den*(1.0+chir_dep+quad_dep*M2/den)*(1.0-fitted_FSE)+disc_eff;
}
