...
{return e2*2/pow(4*M_PI*f0,2.0)*(l6-1-log(ml/ml_phys)+A_pion_charge_radius*(ml-ml_phys))/(L*a*L*a*L*a)/3.0*D1*M;}
			     ...
			     const Ta &a,const Tpars &adep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return e2*sqr(f0)*(4*Cf04+chir_dep+K*M2/den)+disc_eff;
}
			    ...
			    const vector<cont_chir_fit_data_t> &ext_data,const dboot_t &ml_phys,const string &path,size_t an_flag,bool cov_flag)
{
  ...
  cont_chir_fit_minimize(ext_data,pars,boot_fit,2.0,0.0,[an_flag](const vector<double> &p,const cont_chir_fit_pars_t &pars,double ml,double ms,double ac,double L)
			 {return cont_chir_ansatz_dM2Pi(p[pars.if0],p[pars.iB0],p[pars.iC],p[pars.iKPi],p[pars.iK2Pi],ml,ac,p[pars.iadep],p[pars.iadep_ml],an_flag);},cov_flag);
  dboot_t phys_res=cont_chir_ansatz_dM2Pi(pars.fit_f0,pars.fit_B0,pars.C,pars.KPi,pars.K2Pi,ml_phys,a_cont,pars.adep,pars.adep_ml,an_flag);
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {if(univ_full_sub==0)
			...
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)/sqr(pars.fit_a[ib])-
				       without_with_fse*FSE_dep_pion_savage_new_exp(pars.L3dep,dboot_t(pow(2*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_a[ib],ext_data[idata].L));
		      }
		  },
				...
				const Ta &a,const Tpars &adep,double L,const Tpars &fvedep,const size_t an_flag)
{
  ...
  return Kc*(1+chir_dep)+K*M2/den+disc_eff+fitted_FSE;
}
			      ...
			      const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return Kpi0/(4*Cf04)*M2/den*(1+chir_dep)+disc_eff+fitted_FSE;
}
			     ...
			     const Ta &a,const Tpars &adep,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=Klog*(3+16*Cf04)*M2/(4*Cf04*den)*log(M2/pow(mu_MS,2.0));
  else                 chir_dep=0;
			       ...
			       const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return (4/3.0+3/(4*Cf04))*(Kk+chir_dep+Kpi*M2/den)*(1-fitted_FSE)+disc_eff;
}
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {if(univ_full_sub==0)
			...
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)*
				       (1+without_with_fse*FSE_dep_pion_savage_new_exp(pars.L3dep,dboot_t(pow(2*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_a[ib],ext_data[idata].L)));
		      }
		  },
				  ...
				  const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const size_t an_flag)
{
  ...
  return Kk0/(4*Cf04)*(1+chir_dep+K*M2/den)+disc_eff+fitted_FSE;
}
    ...
    plot_chir_fit(combine(path.c_str(),(univ_full_sub==0)?"_univ":"_full"),ext_data,pars,
		  ...
		  {if(univ_full_sub==0)
			...
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wofse)/sqr(pars.fit_a[ib]));
		      ...
		      {
			return dboot_t((without_with_fse?ext_data[idata].wfse:ext_data[idata].wfse)/sqr(pars.fit_a[ib])-
				       without_with_fse*FSE_dep_pion_savage_new(pars.L3dep,dboot_t(pow(2*pars.fit_B0*ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib],0.5)),pars.fit_f0,dboot_t(ext_data[idata].aml/pars.fit_a[ib]/pars.fit_z[ib]),pars.fit_ml_phys,pars.fit_a[ib],ext_data[idata].L));
		      }
		  },
		  ml_phys,phys_res,"$$(M^2_{\\pi^+}-M^2_{\\pi^0}) [GeV^2]");
				...
				const Ta &a,const Tpars &adep,double L,const Tpars &L3dep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  Tpars chir_dep;
  if(chir_an(an_flag)) chir_dep=-8/3*M2/den*log(M2/pow(mu_MS,2.0));
  else                 chir_dep=quad_dep*pow(M2/den,2.0);
  ...
  return e2*sqr(f0)*4*Cf04*(Kk+chir_dep+Kpi*M2/den)+disc_eff+fitted_FSE;
}
			       ...
			       const Ta &a,const Tpars &adep,const Tpars &adep_ml,const size_t an_flag)
{
  ...
  return (4/3.0+3/(4*Cf04))*(Kk+chir_dep+Kpi*M2/den)+disc_eff;
}
