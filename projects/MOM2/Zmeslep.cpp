	...
	for(size_t r_ou=0;r_ou<nr;r_ou++)
	  {
	      ...
	      cout<<"deltam_cr["<<im_r_ind.descr(im_r_in)<<"]: "<<deltam_cr[im_r_in].ave_err()<<endl;
	      cout<<"deltam_cr["<<im_r_ind.descr(im_r_in)<<"]: "<<deltam_cr[im_r_ou].ave_err()<<endl;
	      cout<<"deltam_tm["<<im_r_ind.descr(im_r_in)<<"]: "<<deltam_tm[im_r_in].ave_err()<<endl;
	      cout<<"deltam_tm["<<im_r_ind.descr(im_r_in)<<"]: "<<deltam_tm[im_r_ou].ave_err()<<endl;
