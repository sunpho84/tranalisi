  ...
  if(pars::use_QED)
    {
      ...
      //load corrections
      //const djvec_t V0P5_LL=get(_F,_F,"V0P5",IM,EVN,rfw,rdiff);
      const djvec_t V0P5_00=get(_LO,_LO,"V0P5",IM,EVN,rfw,rdiff);
      const djvec_t V0P5_0M=get(_LO,_FF,"V0P5",IM,EVN,rfw,rdiff);
      //const djvec_t V0P5_M0=get(_FF,_LO,"V0P5",IM,EVN,rfw,rdiff);
      const djvec_t V0P5_0T=get(_LO,_T,"V0P5",IM,EVN,rfw,rdiff);
      const djvec_t V0P5_0S=get(_LO,_S,"V0P5",IM,EVN,rfw,rdiff);
      //const djvec_t V0P5_T0=get(_T,_LO,"V0P5",IM,EVN,rfw,rdiff);
      //load the derivative wrt counterterm
      const djvec_t V0P5_0P=get(_LO,_P,"V0P5",IM,EVN,rfw,rdiff);
      
      //const djvec_t V0P5_P0=get(_P,_LO,"V0P5",IM,EVN,rfw,rdiff);
	...
	-V0P5_0P;
      ...
      deltam_cr=constant_fit(deltam_cr_corr,tmin,tmax,dir_path+"/plots/deltam_cr_m"+to_string(im)+"_rfw"+to_string(rfw)+".xmg");
    }
