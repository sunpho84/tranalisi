	...
	for(size_t meslepins=0;meslepins<pr_meslep::nins;meslepins++)
	  {
	      ...
	      for(size_t im_in=im_ou;im_in<nm;im_in++)
		{
		  ...
		  y_plot[i]=(0.0*pr[im_r_im_r_meslepins_iop_iproj_imeslepmom_ind({im_in,r_in,im_ou,r_ou,meslepins,iop,iproj,imeslepmom})]+
			     2.0*pr[im_r_im_r_meslepins_iop_iproj_imeslepmom_ind({im_ou,r_in,im_in,r_ou,meslepins,iop,iproj,imeslepmom})])/2.0;
