...
public:
  ...
  static size_t nprop_kind(const bool use_QED)
  {
  ...
  static dcompl_t coeff_to_read(const size_t ikind,const size_t r,const bool use_QED)
  {
    const size_t nmax=m_r_mom_conf_qprops_t::nprop_kind(use_QED);
